# --- STAGE 1: Build Stage ---
    ...
    RUN flutter precache --web# --- STAGE 1: Build Stage ---
        FROM ubuntu:22.04 AS build-env
        ...
        # FIX: Disable analytics and force-precache only what is necessary
        ...
        # RUN flutter pub get is fine, but ensure we build strictly for web
        RUN flutter pub get
